...
const typeConfig = {
  buy:      { label: "BUY",      color: "var(--green)", bg: "var(--green-bg)", border: "var(--green)",   Icon: IconArrowUp },
  sell:     { label: "SELL",     color: "var(--red)",   bg: "var(--red-bg)",   border: "var(--red)",  Icon: IconArrowDown },
  transfer: { label: "TRANSFER", color: "var(--text-2)", bg: "var(--surface-3)", border: "var(--border-strong)",        Icon: IconArrowRight },
  ...
  return (
    ...
    >
      <div style={{ padding: "16px" }}>
        ...
        <div className="tx-card-row1" style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "80px 1fr", rowGap: 8, marginBottom: 16 }}>
          
          <span className="mono" style={{ fontSize: 11, color: "var(--text-3)", letterSpacing: "0.05em", alignSelf: "center" }}>ACTION</span>
          <span style={{
            display: "inline-flex", alignItems: "center", gap: 6,
            padding: "2px 6px", borderRadius: 4, fontSize: 11, fontWeight: 700, letterSpacing: "0.05em",
            backgroundColor: "transparent", color: cfg.color, border: `1px solid ${cfg.border}`,
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", borderTop: "1px dashed var(--border)", paddingTop: 12 }}>
          <span className="mono" style={{
            fontSize: 11, color: "var(--text-2)",
            backgroundColor: "var(--surface-3)", padding: "4px 8px",
          ...
          <button
            ...
            style={{
              ...
              transition: "all 0.15s cubic-bezier(0.16, 1, 0.3, 1)", flexShrink: 0,
            }}
          >
            <IconSparkle />
